...
export default function Home() {
  ...
  useEffect(() => {
    document.title = "High-Precision Lab DC Power Supply | Premium Test Equipment";
  }, []);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/how-to-choose" className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-transparent text-zinc-300 border border-zinc-700 rounded-sm font-bold text-sm tracking-widest uppercase hover:bg-zinc-800 hover:text-white transition-colors">
                  Read Guide
                </Link>
              </div>
            </motion.div>
              ...
              >
                ...
                <div className="w-full relative z-10 flex flex-col items-center justify-center min-h-[300px]">
                  ...
                  <div className="hidden absolute inset-0 w-full aspect-[4/3] bg-zinc-800/80 backdrop-blur-sm rounded-xl border border-zinc-700/50 flex-col items-center justify-center text-center p-6 z-10">
                    ...
                    <div className="text-zinc-300 font-medium tracking-wide mb-2">图片预留位 (Hero Product)</div>
                    <div className="text-xs text-zinc-500 max-w-[250px] text-center leading-relaxed">
                      ...
                      并放入项目的 <code className="text-zinc-300">public</code> 文件夹中。
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <Link to="/applications" className="mt-4 inline-flex items-center text-brand-600 text-sm font-medium hover:text-brand-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative w-full aspect-[4/3] bg-zinc-50 border border-zinc-200 flex flex-col items-center justify-center p-8 group overflow-hidden">
              ...
              />
              {/* Local Development Placeholder */}
              <div className="hidden absolute inset-0 w-full h-full bg-zinc-100 flex-col items-center justify-center text-center p-6 z-10">
                <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center mb-4 border border-zinc-200 shadow-sm">
                  <span className="text-2xl">⚡</span>
                </div>
                <div className="text-zinc-800 font-medium tracking-wide mb-2">图片预留位 (Best Seller)</div>
                <div className="text-xs text-zinc-500 max-w-[250px] text-center leading-relaxed">
                  本地开发时，请将第二张图重命名为<br/>
                  <code className="text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded mx-1 border border-amber-200">bestseller-product.png</code><br/>
                  并放入项目的 <code className="text-zinc-600">public</code> 文件夹中。
                </div>
              </div>
